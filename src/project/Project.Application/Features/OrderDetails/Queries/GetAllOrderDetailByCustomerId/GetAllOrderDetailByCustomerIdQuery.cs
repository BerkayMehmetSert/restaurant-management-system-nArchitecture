...
namespace Project.Application.Features.OrderDetails.Queries.GetAllOrderDetailByCustomerId
{
    public class GetAllOrderDetailByCustomerIdQuery : IRequest<OrderDetailListModel>
    {
        public PageRequest PageRequest { get; set; }
        public int CustomerId { get; set; }

        public class GetAllOrderDetailByCustomerIdQueryHandler : IRequestHandler<GetAllOrderDetailByCustomerIdQuery, OrderDetailListModel>
        {
            private readonly IOrderDetailRepository _orderDetailRepository;
            private readonly IMapper _mapper;
            private readonly OrderDetailBusinessRules _orderDetailBusinessRules;

            public GetAllOrderDetailByCustomerIdQueryHandler(IOrderDetailRepository orderDetailRepository,
            ...
            public async Task<OrderDetailListModel> Handle(GetAllOrderDetailByCustomerIdQuery request,
